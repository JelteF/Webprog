              ...
              <div class="span8 offset2">
                ...
                <div class="input">
                  <form name="postForm"  action=<?php echo "ajaxphp/post.php?studie=$studie_id"; ?> method="post" enctype="multipart/form-data" target="post_target" class="pull-left" onsubmit="startUpload();">
                    ...
                    <p></p>
                    <textarea id="textarea" <?php if(!$validated) echo "disabled placeholder='Om te kunnen posten moet je inloggen. Dat kan gewoon met je UvAnetID.'";?> name="beschrijving" class="span8" rows="4"  ></textarea>
